...
#
# Script generated by Vivado on Thu May 16 21:01:17 -0300 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ModuloClockingWizard.sh
...
#
# Usage        : ModuloClockingWizard.sh
#                ModuloClockingWizard.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ModuloClockingWizard.sh [-reset_run]
#                ModuloClockingWizard.sh [-reset_log]
#                ModuloClockingWizard.sh [-help]
#
...
# script info
echo -e "ModuloClockingWizard.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ModuloClockingWizard.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ModuloClockingWizard xil_defaultlib.ModuloClockingWizard xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ModuloClockingWizard -key {Behavioral:sim_1:Functional:ModuloClockingWizard} -tclbatch cmd.tcl -protoinst "protoinst_files/ModuloClockingWizard.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Estudio/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ModuloClockingWizard.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ModuloClockingWizard.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ModuloClockingWizard.sh [-help]\n\
Usage: ModuloClockingWizard.sh [-step]\n\
Usage: ModuloClockingWizard.sh [-lib_map_path]\n\
Usage: ModuloClockingWizard.sh [-reset_run]\n\
Usage: ModuloClockingWizard.sh [-reset_log]\n\
Usage: ModuloClockingWizard.sh [-keep_index]\n\
Usage: ModuloClockingWizard.sh [-noclean_files]\n\n\
