...
#                script (type 'ModuloClockingWizard.sh -help' for more information).
#
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../TP-5-Integrador.gen/sources_1/bd/ModuloClockingWizard/ipshared/c2c6" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ModuloClockingWizard xil_defaultlib.glbl -o ModuloClockingWizard_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ModuloClockingWizard_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ModuloClockingWizard_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ModuloClockingWizard_simv.daidir vcs_lib c.obj)
