...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../TP-5-Integrador.gen/sources_1/bd/ModuloClockingWizard/ipshared/c2c6" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ModuloClockingWizard xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ModuloClockingWizard -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ModuloClockingWizard_sc.so .tmp_log xcelium_lib waves.shm c.obj)
