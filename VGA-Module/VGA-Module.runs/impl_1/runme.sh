...
HD_PWD='D:/Estudio/Lenguajes-descriptivos-de-hardware/repo/verilog/VGA-Module/VGA-Module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGAModule.tcl -notrace
