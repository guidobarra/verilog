...
HD_PWD='D:/Estudio/Lenguajes-descriptivos-de-hardware/repo/verilog/VGA-Module/VGA-Module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGAModule.tcl
